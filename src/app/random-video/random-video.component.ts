...
export class RandomVideoComponent implements OnInit, OnDestroy {
  ...
  private introvertiertVideos: string[] = ['Langsam_auf_der_Autobahn.mp4', 'risikobereitschaft_intro.mp4'];
  private extrovertiertVideos: string[] = ['Autobahn_rasen.mp4', 'langes_ueberhohlen.mp4'];
  @Input() results: any[] = [];
